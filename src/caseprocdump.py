...
class CaseProcDump(taskmods.DllList):
    ...
    def render_text(self, outfd, data):
        ...
        for task in data:
            ...
            # Creating and printing property bundle based on data extracted 
            # from memory.
            self.action.create_property_bundle(
                ...
                ImageBase=task.Peb.ImageBaseAddress,
